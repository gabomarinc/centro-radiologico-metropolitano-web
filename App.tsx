      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-3 group">
          ...
          <div>
            ...
            <span className="text-[10px] tracking-widest uppercase font-bold text-blue-600 block mt-0.5 text-center md:text-left">Panamá | Radiología</span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-10">
          {[
            ...
            <Link 
              key={item.name} 
              to={item.path} 
              className={`text-sm font-semibold transition-colors ${pathname === item.path ? 'text-blue-600' : 'text-slate-600 hover:text-blue-600'}`}
            >
              {item.name}
            </Link>
          ))}
          <Link to="/contacto" className="bg-blue-600 text-white px-7 py-3 rounded-full text-sm font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 hover:shadow-blue-200 active:scale-95">
            Agendar Cita
          </Link>
        </div>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-t border-slate-100 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="p-6 space-y-4">
            ...
            <Link 
              to="/contacto" 
              onClick={() => setIsOpen(false)}
              className="block w-full bg-blue-600 text-white text-center py-4 rounded-2xl font-bold"
            >
              Agendar Cita
            </Link>
          </div>
      ...
      <div className="grid md:grid-cols-4 gap-16 mb-20">
        <div className="col-span-2">
          ...
          <div className="flex space-x-5">
            {[MessageCircle, Phone, Activity].map((Icon, i) => (
              <a key={i} href="#" className="w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                <Icon size={20} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-4 font-medium">
            {SERVICES.map(s => (
              <li key={s.id}><Link to="/servicios" className="hover:text-blue-500 transition-colors">{s.title}</Link></li>
            ))}
          </ul>
        </div>
    ...
    <div className="fixed bottom-8 right-8 z-[60]">
      {isOpen ? (
        <div className="bg-white w-[380px] h-[550px] rounded-[32px] shadow-2xl border border-slate-100 flex flex-col overflow-hidden animate-in slide-in-from-bottom-8 duration-500">
          ...
          <div className="p-4 bg-white border-t border-slate-100 flex items-center space-x-3">
            <input 
              ...
              className="flex-1 bg-slate-50 border-none rounded-2xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 transition-all outline-none"
            />
            <button 
              onClick={handleSend}
              className="w-12 h-12 bg-blue-600 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all active:scale-90"
            >
              <ArrowRight size={20} />
            </button>
          </div>
        ...
        <button 
          ...
          className="bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all group relative"
        >
  ...
  <div className="relative">
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/80 via-white to-transparent"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center pt-20">
        <div className="animate-in fade-in slide-in-from-left-12 duration-1000">
          <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 text-blue-700 px-4 py-2 rounded-full text-[10px] font-extrabold uppercase tracking-[0.2em] mb-10">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold text-slate-950 leading-[1.05] mb-8 text-balance">
            Tecnología <br /> de punta en <span className="text-blue-600 italic">Panamá.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
            <Link to="/contacto" className="bg-blue-600 text-white px-10 py-5 rounded-[20px] font-bold text-lg hover:bg-blue-700 transition-all shadow-2xl shadow-blue-100 flex items-center justify-center space-x-3 group">
              <span>Agendar mi estudio</span>
              <ArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/servicios" className="flex items-center justify-center space-x-3 text-slate-900 font-bold hover:text-blue-600 transition-colors group">
              <span className="border-b-2 border-slate-900 group-hover:border-blue-600 py-1 transition-all">Ver especialidades</span>
        ...
        <div className="relative hidden lg:block animate-in zoom-in duration-1000 delay-300">
           <div className="absolute -top-20 -right-20 w-[500px] h-[500px] bg-blue-100/50 rounded-full blur-[100px] -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12">
          <div className="p-10 rounded-[40px] bg-slate-50 border border-slate-100 flex flex-col items-center text-center group hover:bg-white hover:shadow-2xl transition-all">
            <div className="w-20 h-20 bg-blue-600 text-white rounded-[28px] flex items-center justify-center mb-8 shadow-xl shadow-blue-100 group-hover:-translate-y-2 transition-transform">
              <TrendingUp size={36} />
            </div>
          ...
          <div className="p-10 rounded-[40px] bg-slate-50 border border-slate-100 flex flex-col items-center text-center group hover:bg-white hover:shadow-2xl transition-all">
            <div className="w-20 h-20 bg-teal-500 text-white rounded-[28px] flex items-center justify-center mb-8 shadow-xl shadow-teal-100 group-hover:-translate-y-2 transition-transform">
              <ShieldCheck size={36} />
            </div>
          ...
          <div className="p-10 rounded-[40px] bg-slate-50 border border-slate-100 flex flex-col items-center text-center group hover:bg-white hover:shadow-2xl transition-all">
            <div className="w-20 h-20 bg-blue-900 text-white rounded-[28px] flex items-center justify-center mb-8 shadow-xl shadow-slate-200 group-hover:-translate-y-2 transition-transform">
              <Users size={36} />
            </div>
    ...
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-950 mb-6">Su salud en <span className="text-blue-600">3 simples pasos.</span></h2>
        ...
        <div className="grid md:grid-cols-3 gap-16 relative">
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-blue-100 -translate-y-1/2 -z-10"></div>
          <div className="bg-white p-12 rounded-[48px] border border-slate-100 shadow-sm text-center relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center font-black">1</div>
            <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-8"><Search size={32} /></div>
          ...
          <div className="bg-white p-12 rounded-[48px] border border-slate-100 shadow-sm text-center relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center font-black">2</div>
            <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-8"><Calendar size={32} /></div>
          ...
          <div className="bg-white p-12 rounded-[48px] border border-slate-100 shadow-sm text-center relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center font-black">3</div>
            <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-8"><FileText size={32} /></div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-950 mb-6 leading-tight">Excelencia Médica <br /><span className="text-blue-600 italic">a su alcance.</span></h2>
          ...
          <Link to="/servicios" className="group flex items-center space-x-3 text-blue-600 font-bold text-lg mb-2">
            <span>Ver portafolio Panamá</span>
            <div className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center shadow-md group-hover:bg-blue-600 group-hover:text-white transition-all">
              <ChevronRight />
            </div>
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {SERVICES.map((s) => (
            <div key={s.id} className="group bg-white p-10 rounded-[40px] border border-slate-100 hover:border-blue-100 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.06)] transition-all duration-500 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center text-white mb-8 shadow-xl shadow-blue-100 group-hover:-translate-y-2 transition-transform">
                  {IconMap[s.iconName]}
                </div>
                ...
                <Link to={`/servicios`} className="text-blue-600 font-bold text-sm inline-flex items-center space-x-2 group/btn">
    ...
    <section className="py-32 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            <div className="bg-blue-600 rounded-[60px] p-2 rotate-2 scale-[1.02]">
              <img 
            ...
            <div className="absolute -bottom-10 -right-10 bg-white rounded-[40px] shadow-2xl p-10 max-w-sm border border-slate-50">
               ...
               <span className="font-extrabold text-blue-600 uppercase tracking-widest text-xs">— María Castillo, Paciente</span>
            </div>
          </div>
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-950 mb-8 leading-tight">Expertos en <br /><span className="text-blue-600 italic">cuidar de usted.</span></h2>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-blue-600 rounded-[64px] p-16 md:p-32 text-center relative overflow-hidden text-white">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-blue-400 via-transparent to-transparent opacity-50"></div>
          <h2 className="text-5xl md:text-7xl font-extrabold mb-10 relative z-10 leading-none">Su salud no <br /> puede esperar.</h2>
          <p className="text-xl md:text-2xl text-blue-50 mb-16 max-w-2xl mx-auto font-medium relative z-10">Agenda hoy mismo tu estudio en nuestras sedes de Marbella o Costa del Este.</p>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-8 relative z-10">
            <Link to="/contacto" className="bg-white text-blue-600 px-12 py-6 rounded-3xl font-black text-xl hover:scale-105 transition-all shadow-2xl">
              Agendar Cita Ahora
            </Link>
        ...
        {SERVICES.map((s, idx) => (
          <div key={s.id} className={`flex flex-col lg:flex-row items-center gap-24 ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
            ...
            <div className="flex-1">
              <span className="text-blue-600 font-extrabold uppercase tracking-[0.3em] text-sm block mb-6">Diagnóstico Panamá</span>
              ...
              <div className="bg-slate-50 rounded-[40px] p-10 border border-slate-100 mb-12">
                <h4 className="text-xl font-extrabold text-slate-900 mb-6 flex items-center space-x-3">
                  <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center"><Calendar size={18} className="text-blue-600" /></div>
              ...
              <Link to="/contacto" className="inline-flex items-center space-x-4 bg-slate-950 text-white px-10 py-5 rounded-2xl font-bold hover:bg-blue-600 transition-all shadow-xl active:scale-95 group">
          ...
          <div key={b.id} className="bg-white rounded-[60px] shadow-2xl overflow-hidden group border border-white">
            <div className="h-80 relative overflow-hidden">
               ...
               <div className="absolute top-8 left-8">
                  <span className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full text-blue-600 font-black text-xs uppercase tracking-widest">{b.id === 'marbella' ? 'Principal' : 'Sede Este'}</span>
               </div>
            </div>
            <div className="p-12">
               ...
               <div className="space-y-8 mb-12">
                  <div className="flex items-start space-x-5">
                    <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center shrink-0 text-blue-600"><MapPin size={24} /></div>
                    <p className="text-lg text-slate-600 font-bold leading-relaxed">{b.address}</p>
                  </div>
                  <div className="flex items-center space-x-5">
                    <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center shrink-0 text-blue-600"><Phone size={24} /></div>
                    <p className="text-2xl text-slate-950 font-black">{b.phone}</p>
                  </div>
                  <div className="flex items-start space-x-5">
                    <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center shrink-0 text-blue-600"><Clock size={24} /></div>
               ...
               <div className="grid grid-cols-2 gap-4">
                  ...
                  <Link to="/contacto" className="bg-blue-600 text-white text-center py-5 rounded-3xl font-bold shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all">Agendar Cita</Link>
               </div>
            </div>
          </div>
        ))}
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            {['Wifi Alta Velocidad', 'Café & Snacks', 'Valet Parking', 'Accesibilidad Universal'].map((feat, i) => (
              <div key={i} className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-3xl">
                <div className="text-blue-500 mb-4 flex justify-center"><CheckCircle2 size={32} /></div>
  ...
  <div className="pt-32">
    ...
    <section className="pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            <span className="text-blue-600 font-black uppercase tracking-[0.4em] text-xs mb-8 block">Excelencia Panameña</span>
            <h1 className="text-5xl md:text-8xl font-extrabold text-slate-950 mb-10 leading-[0.95] tracking-tighter">Pasión por la <br /><span className="text-blue-600">precisión.</span></h1>
  ...
  <div className="pt-32 pb-32 medical-gradient min-h-screen">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid lg:grid-cols-2 gap-24">
        <div>
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-950 mb-10 leading-none">Cerca de usted <br /> en <span className="text-blue-600">Panamá.</span></h1>
        ...
        <div className="bg-white p-12 md:p-16 rounded-[60px] shadow-2xl shadow-blue-200/50 border border-slate-50 relative overflow-hidden">
          ...
          <form className="space-y-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input type="text" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-slate-900 font-bold focus:ring-2 focus:ring-blue-600 outline-none transition-all" placeholder="Ej. Ricardo Martinelli" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Teléfono Panamá</label>
                <input type="tel" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-slate-900 font-bold focus:ring-2 focus:ring-blue-600 outline-none transition-all" placeholder="+507 XXXX-XXXX" />
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Correo Electrónico</label>
              <input type="email" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-slate-900 font-bold focus:ring-2 focus:ring-blue-600 outline-none transition-all" placeholder="paciente@metropolitano.com.pa" />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Tipo de Estudio</label>
              <select className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-slate-900 font-bold focus:ring-2 focus:ring-blue-600 outline-none transition-all appearance-none">
            ...
            <button type="submit" className="w-full bg-blue-600 text-white font-extrabold py-5 rounded-[24px] text-lg hover:bg-blue-700 hover:shadow-2xl shadow-blue-200 transition-all active:scale-95">
